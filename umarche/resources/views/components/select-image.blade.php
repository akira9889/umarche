...
<div class="modal micromodal-slide" id="{{ $modal }}" aria-hidden="true">
    <div class="modal__overlay -50z" tabindex="-1" data-micromodal-close>
        <div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="{{ $modal }}-title">
            <header class="modal__header">
                <h2 class="text-sl text-gray-700" id="{{ $modal }}-title">
                    ファイルを選択してください
                </h2>
                    ...
                    @foreach ($images as $image)
                        <div class="w-1/4 p-2 md:p-4">
                            <div class="border rouded-md p-2 md:p-4">
                                ...
                                <div class="text-gray-700 text-xs md:text-sm dark:text-white">{{ $image->title }}</div>
                            </div>
                        </div>
                    @endforeach
                </div>
            ...
            <footer class="modal__footer">
                <button type="button" class="modal__btn" id="{{ $modal }}_close" data-micromodal-close aria-label="閉じる">閉じる</button>
            </footer>
        </div>
    </div>
</div>
...
<div class="flex justify-between items-center my-4 py-4 w-1/2 mx-auto">
