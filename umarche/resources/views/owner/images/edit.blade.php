            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('owner.images.update', ['image' => $image->id]) }}" method="post">
                        ...
                        <div class="-m-2">
                            <div class="p-2 w-1/2 mx-auto">
                                ...
                                <div class="relative">
                                    <label for="title" class="leading-7 text-sm text-gray-600 dark:text-white">画像タイトル</label>
                            ...
                            <div class="p-2 flex justify-center mt-4">
                                <button type="button" onclick="location.href='{{ route('owner.images.index') }}'"
                                    class="bg-gray-200 dark:bg-gray-400 border-0 py-2 px-8 mr-8 focus:outline-none hover:bg-gray-400 dark:hover:bg-gray-600 rounded text-lg">戻る</button>
                                <button type="submit"
                    ...
                    <form id="delete_{{ $image->id }}"
                        action="{{ route('owner.images.destroy', ['image' => $image->id]) }}" method="post">
                        @csrf
                        @method('delete')
