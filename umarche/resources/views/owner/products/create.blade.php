                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('owner.products.store') }}" method="post">
                        ...
                        <div class="-m-2">
                            ...
                            <div class="p-2 md:w-1/2 mx-auto">
                                <div class="relative">
                                    ...
                                    <textarea id="information" name="information" required rows="10"
                                        class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base text-left outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">{{ old('information') }}</textarea>
                            ...
                            <div class="p-2 md:w-1/2 mx-auto">
                                <div class="relative">
                                    <label for="categoty" class="leading-7 text-sm text-gray-600">カテゴリー</label>
