                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="md:flex md:justify-around">
                        ...
                        <div class="md:w-1/2 md:pl-4 flex flex-col">
                            ...
                            <h1 class="mb-4 text-gray-900 text-3xl title-font font-medium dark:text-white">{{ $product->name }}</h1>
                                    ...
                                    <div class="flex items-center mr-6">
                                        ...
                                        <div class="relative">
                                            <select name="quantity"
                                                class="rounded border appearance-none border-gray-300 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 text-base pl-3 pr-10 text-gray-700">
        ...
        <div class="modal__overlay z-50" tabindex="-1" data-micromodal-close>
            <div class="modal__container w-1/2" role="dialog" aria-modal="true" aria-labelledby="modal-1-title">
                <header class="modal__header">
                    <h2 class="text-sl text-gray-700 modal__title" id="modal-1-title">
                        {{ $product->shop->name }}
                    </h2>
